...
from data import OversamplingDataset, ProcessedDataset
...
def main(run_conf, da_conf, exp_dir):
    ...
    if da_config["da_type"] == "dann" and not da_config["da_spec_config"]["dann"]["auto_critic_update"]:
        ...
        clf_optim = torch.optim.Adam(
            list(clf_model.parameters()) + da.get_da_params(), lr=run_conf["lr"], weight_decay=0.001
        )
    else:
...
if __name__ == "__main__":
    ...
    da_config = {
        ...
        "adv_config": {
            "da_net_config": {"layers_width": [32, 16], "act_function": "relu", "dropout": 0.0},
